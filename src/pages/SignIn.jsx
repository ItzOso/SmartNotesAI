...
function SignIn() {
  ...
  const { signin, signinError, googleSignin, error } = useAuth();
    ...
    <div className="text-center mx-auto max-w-md pt-28">
      ...
      <div className="p-6 border border-gray rounded-lg">
        ...
        <button
          ...
          disabled={loading}
          className="btn-primary flex gap-2 w-full justify-center disabled:opacity-75 items-center my-4 bg-white border border-gray hover:bg-gray-light"
        >
          <svg
            version="1.1"
